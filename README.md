...
## Submission
- Submit your Python code, plots (save as images), and answers to all questions. using Github 
- Write a short paragraph (3–5 sentences) explaining what you learned about the Perceptron using the robot librarian analogy. Submit using Github 
